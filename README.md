...
| ID     | Task                                                                                                     | Status |
| ------ | -------------------------------------------------------------------------------------------------------- | ------ |
| APP-01 | Make SQL `applications.applied_at` nullable to match pending application behavior.                       | TODO   |
| APP-02 | Remove the duplicate applications foreign-key declaration.                                               | TODO   |
| APP-03 | Recreate `app/db/hunter-agent.db` from the schema and seed scripts after the schema fixes.               | TODO   |
| APP-04 | Align required SQLModel job and profile fields with SQL `NOT NULL` constraints.                          | TODO   |
...
| APP-08 | Remove obsolete application placeholders after the SQLModel service works.                               | TODO   |
| APP-09 | Add temporary SQLite fixtures and FastAPI dependency overrides for isolated tests.                       | TODO   |
| APP-10 | Activate the schema-and-seed replay test.                                                                | TODO   |
